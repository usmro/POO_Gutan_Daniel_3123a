...
string Medic::getParola() { return parola; }
...
void Medic::setParola(string parolaNoua) { parola = parolaNoua; }
...
void Medic::afisareDetaliata() {
    ...
    cout << "User login: ID " << id << " | Parola: ********" << endl;

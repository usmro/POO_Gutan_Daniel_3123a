...
string Angajat::getNumeFamilie() { return nume; }
string Angajat::getPrenume() { return prenume; }
string Angajat::getCnp() { return cnp; }
string Angajat::getDataNasterii() { return dataNasterii; }
string Angajat::getTelefon() { return telefon; }
string Angajat::getEmail() { return email; }
string Angajat::getAdresa() { return adresa; }
string Angajat::getDataAngajarii() { return dataAngajarii; }
string Angajat::getIban() { return iban; }
string Angajat::getTipContract() { return tipContract; }
